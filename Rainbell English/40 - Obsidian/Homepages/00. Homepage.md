...
- **AGENDA**
	...
	- [Monthly]((obsidian://advanced-uri?vault=Rainbell%20English&commandid=calendar%253Aopen-monthly-note))
- **LIFE**
	- [[00. Library|Library]]
	- [[Qin|Myself]]
	- [[00. Files|Files]]
...
const thousandSeparator = source.thousandSeparator;

const useThousandSeparator = source.useThousandSeparator;
...
if (!useThousandSeparator) return numText;

if (num >= 10000) numText = numText.slice(0, -3) + thousandSeparator + numText.slice (-3); // eslint-disable-line no-magic-numbers
